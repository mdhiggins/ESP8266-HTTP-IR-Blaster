...
void sendCodePage(Code selCode, int httpcode){
  ...
  server.sendContent("      function setUrl(id,host,port,path) {\n");
  server.sendContent("        document.getElementById(id).textContent = 'http://'+host+':'+port+path;\n");
  server.sendContent("      }\n");
  server.sendContent("      </script>\n");
  ...
  server.sendContent("            <li><pre id='json-hostname'></pre></li>\n");
  server.sendContent("            <li>Local IP <span class='label label-default'>JSON</span></li>\n");
  server.sendContent("            <li><pre id='json-local-ip'></pre></li>\n");
  server.sendContent("            <li>External IP <span class='label label-default'>JSON</span></li>\n");
  server.sendContent("            <li><pre id='json-external-ip'></pre></li></ul>\n");
  server.sendContent("          <script>\n");
  server.sendContent("          var path = '/json?plain='+encodeURIComponent(\"[{'data':[" + String(selCode.raw) + "], 'type':'raw', 'khz':38}]\");");
  server.sendContent("          setUrl('json-hostname','" + String(host_name) + ".local','" + String(port) + "',path);\n");
  server.sendContent("          setUrl('json-local-ip','" + WiFi.localIP().toString() + "','" + String(port) + "',path);\n");
  server.sendContent("          setUrl('json-external-ip','" + externalIP() + "','" + String(port) + "',path);\n");
  server.sendContent("          </script>\n");
  } else {
  server.sendContent("      <div class='row'>\n");
  server.sendContent("        <div class='col-md-12'>\n");
  ...
  server.sendContent("            <li><pre id='msg-hostname'></pre></li>\n");
  server.sendContent("            <li>Local IP <span class='label label-default'>MSG</span></li>\n");
  server.sendContent("            <li><pre id='msg-local-ip'></pre></li>\n");
  server.sendContent("            <li>External IP <span class='label label-default'>MSG</span></li>\n");
  server.sendContent("            <li><pre id='msg-external-ip'></pre></li></ul>\n");
  server.sendContent("          <ul class='list-unstyled'>\n");
  server.sendContent("            <li>Hostname <span class='label label-default'>JSON</span></li>\n");
  server.sendContent("            <li><pre id='json-hostname'></pre></li>\n");
  server.sendContent("            <li>Local IP <span class='label label-default'>JSON</span></li>\n");
  ...
  server.sendContent("            <li><pre id='json-external-ip'></pre></li></ul>\n");
  server.sendContent("          <script>\n");
  server.sendContent("          var path = '/msg?code='+encodeURIComponent(\"" + String(selCode.data) + ":" + String(selCode.encoding) + ":" + String(selCode.bits) + "\");\n");
  server.sendContent("          setUrl('msg-hostname','" + String(host_name) + ".local','" + String(port) + "',path);\n");
  server.sendContent("          setUrl('msg-local-ip','" + WiFi.localIP().toString() + "','" + String(port) + "',path);\n");
  server.sendContent("          setUrl('msg-external-ip','" + externalIP() + "','" + String(port) + "',path);\n");
  server.sendContent("          path = '/json?plain='+encodeURIComponent(\"[{'data':'" + String(selCode.data) + "','type':'" + String(selCode.encoding) + "','length':" + String(selCode.bits) + "}]\");");
  server.sendContent("          setUrl('json-hostname','" + String(host_name) + ".local','" + String(port) + "',path);\n");
  server.sendContent("          setUrl('json-local-ip','" + WiFi.localIP().toString() + "','" + String(port) + "',path);\n");
  server.sendContent("          setUrl('json-external-ip','" + externalIP() + "','" + String(port) + "',path);\n");
  server.sendContent("          </script>\n");
